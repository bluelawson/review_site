...
import { FieldWrapper, SelectField, TextAreaField, TextField } from "@/components/ui/Input";
import { useAuth } from "@/context/AuthContext";
import { useReviews } from "@/context/ReviewContext";
import type { BodyType, PersonalityTone } from "@/types";

const shopOptions = ["水色りぼん", "fantasy", "女帝", "Velvet Garden", "Secret Lagoon"];
const bodyOptions: BodyType[] = ["スレンダー", "標準", "グラマラス", "メリハリ", "小柄", "長身"];
const personalityOptions: PersonalityTone[] = ["明るい", "おとなしい", "積極的", "癒やし系"];
